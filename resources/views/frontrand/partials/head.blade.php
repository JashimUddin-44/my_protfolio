...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			CSS
			============================================= -->
			<link rel="stylesheet" href="{{ asset('frontrand/css/linearicons.css')}}">
			<link rel="stylesheet" href="{{ asset('frontrand/css/font-awesome.min.css')}}">
			<link rel="stylesheet" href="{{ asset('frontrand/css/bootstrap.css')}}">
			<link rel="stylesheet" href="{{ asset('frontrand/css/magnific-popup.css')}}">
