...
@section('title','School Management Home Page')
@section('content')
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							@foreach($institute as $school)
							<h1 class="text-uppercase">
								{{$school->institiute_name}}	
							</h1>
							@endforeach
							<p class="pt-10 pb-10">
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
							...
							@endif
							<form class="form-wrap" action="{{route('add.student')}}" method="post" enctype="multipart/form-data">
								@csrf
