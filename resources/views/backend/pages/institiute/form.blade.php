...
@section('title','Institiute create Form')
...
<div class="container mx-auto">
    <form action="{{route('stocks.data')}}"method="post" enctype="multipart/form-data">
        @csrf
        <div class="form-group my-2">
            <label for="institiute_name">Institiute Name</label>
            <input type="text" name="institiute_name" class="form-control" id="institiute_name" placeholder="institiute_name">
        ...
        <div class="form-group my-2">
            ...
            <input type="text" name="institiute_code" class="form-control" id="institiute_code" placeholder="institiute_code">
        ...
        <div class="form-group my-2">
            ...
            <input type="text" name="institiute_address" class="form-control" id="institiute_address" placeholder="institiute_address">
